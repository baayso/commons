...
package com.baayso.commons.sequence.mongo.assertions;

/**
 * <p>Design by contract assertions.</p> <p>This class is not part of the public API and may be removed or changed at any time.</p>
 *
 * https://github.com/mongodb/mongo-java-driver/blob/master/bson/src/main/org/bson/assertions/Assertions.java
 */
